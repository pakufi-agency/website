...
const PORTFOLIO_DATA: PortfolioItemData[] = [
  {
...
const Services: FC = () => {
  const [items, setItems] = useState<PortfolioItemData[]>(PORTFOLIO_DATA);
  const filterItem = (catItem: string): void => {
            ...
            <div className="portfolio__wrapper">
              <div className="portfolio__content">
                ...
                <div className="portfolio__menu">
                  <button onClick={() => setItems(PORTFOLIO_DATA)}>
                    Show All
                  </button>
                  <button onClick={() => filterItem("ui/ux")}>
                    UI/UX Design
                  </button>
                  <button onClick={() => filterItem("marketing")}>
                    Marketing
                  </button>
                  <button onClick={() => filterItem("development")}>
                    Development
                  </button>
                  <button onClick={() => filterItem("writing")}>
                    Content Writing
                  </button>
                </div>
              </div>
