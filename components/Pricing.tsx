...
const PRICING_MONTHLY: PricingPlan[] = [
  {
    extraClass: "mb-30",
...
const PRICING_YEARLY: PricingPlan[] = [
  {
    extraClass: "mb-30",
    priceTitle: "Professional",
    priceText: "A beautiful, simple website",
...
const Pricing: FC<PricingProps> = ({ extraClass }) => {
  return (
    <section
      className={`pricing__area fix p-relative pt-120 pb-90 ${extraClass}`}
    >
