...
import user1 from "/public/images/legacy/agency-image/agency-user1.png";
import user2 from "/public/images/legacy/agency-image/agency-user2.png";
import user3 from "/public/images/legacy/agency-image/agency-user3.png";
import user4 from "/public/images/legacy/agency-image/agency-user4.png";
import user5 from "/public/images/legacy/agency-image/agency-user5.png";
import user6 from "/public/images/legacy/agency-image/agency-user6.png";
    ...
    <>
      <div className="ml-feedback-area ptb-80">
        ...
        <div className="user-shape1">
          <Image src={user1} alt="shape" width={131} height={143} />
        </div>
        <div className="user-shape2">
          <Image src={user2} alt="shape" width={131} height={143} />
        </div>
        <div className="user-shape3">
          <Image src={user3} alt="shape" width={131} height={143} />
        </div>
        <div className="user-shape4">
          <Image src={user4} alt="shape" width={131} height={143} />
        </div>
        <div className="user-shape5">
          <Image src={user5} alt="shape" width={131} height={143} />
        </div>
        <div className="user-shape6">
          <Image src={user6} alt="shape" width={131} height={143} />
        </div>
      </div>
    </>
  );
